...
(
   ...
   Caller_ID  NUMBER(8) CONSTRAINT Call_Details_FK_Callers REFERENCES Callers (Caller_ID) not null,
   Computer_SN  char(30) CONSTRAINT Call_Details_FK_SN_Lookup REFERENCES SN_Lookup (Computer_SN) not null,
   HD_Operator_ID  Char(6) CONSTRAINT Call_Details_FK_HD_Operators REFERENCES HD_Operators (HD_Operator_ID) not null,
   ...
   Problem_Type_ID  CHAR(6)CONSTRAINT Call_Details_FK_Problem_Category_Codes REFERENCES Problem_Category_Codes (Problem_Type_ID) not null,
...
('TEC1', 'Technician Level 1', null);

INSERT INTO Job_Codes VALUES
('TEC2', 'Technician Level 2', null);

INSERT INTO Job_Codes VALUES
('TEC3', 'Technician Level 3', null);
...
INSERT INTO Equipment_Reg VALUES
(Equip_seq.NEXTVAL, 'Dell', 'Opti_Desk PC', 'Windows 10', '772DFF99(*&C1111', TO_DATE('13-OCT-2019', 'DD-MON-YYYY'), 'SalesForce V5', 10015 );
...
INSERT INTO HD_specialists VALUES (503, 1025, 'HW');
insert into HD_specialists values (504, 1018, 'HW');

------- Insert data --------
-- Call_Details.  
INSERT INTO Call_Details VALUES
(Call_seq.NEXTVAL, 'Briana', 2003, '8500095B', 8001, TO_DATE('21-OCT-2020 14:08', 'DD-MON-YYYY HH24:MI'), NULL, 'Machine will not boot', NULL, 1, 'BOOT4', NULL);
INSERT INTO Call_Details VALUES
(Call_seq.NEXTVAL, 'Melinda', 2006, '2BCf0932A', 8001, TO_DATE('19-OCT-2020 14:08', 'DD-MON-YYYY HH24:MI'), NULL, 'Cannot log into OS', NULL, 1, 'PASS', NULL);
INSERT INTO Call_Details VALUES
(Call_seq.NEXTVAL, 'Shawna', 2000, '2BCf0932A', 8022, TO_DATE('19-OCT-2020 15:08', 'DD-MON-YYYY HH24:MI'), NULL, 'Mouse not working', 504, 1, 'MOUSE', NULL);
INSERT INTO Call_Details VALUES
(Call_seq.NEXTVAL, 'Shawna', 2000, '2BCf0932A', 8022, TO_DATE('10-OCT-2020 14:08', 'DD-MON-YYYY HH24:MI'), TO_DATE('11-OCT-2020', 'DD-MON-YYYY HH24:MI'), 'Screen blank', 502, 0, 'GEN', NULL);
INSERT INTO Call_Details VALUES
(Call_seq.NEXTVAL, 'Briana', 2003, '1BC0095B1', 8001, TO_DATE('13-OCT-2022 14:08', 'DD-MON-YYYY HH24:MI'), NULL, 'Spilt coffee, afraid to turn on', NULL, 1, 'GEN', NULL);
INSERT INTO Call_Details VALUES
(Call_seq.NEXTVAL, 'Melinda', 2006, '2BCf0932A', 8001, TO_DATE('13-OCT-2022 14:08', 'DD-MON-YYYY HH24:MI'), NULL, 'Cannot log into OS', NULL, 1, 'PASS', NULL);
INSERT INTO Call_Details VALUES
(Call_seq.NEXTVAL, 'Shawna', 2000, '2BCf0932A', 8022, TO_DATE('13-OCT-2022 14:08', 'DD-MON-YYYY HH24:MI'), NULL, 'Mouse not working', 504, 1, 'MOUSE', NULL);
INSERT INTO Call_Details VALUES
(Call_seq.NEXTVAL, 'Shawna', 2000, '1BC0095B1', 8022, TO_DATE('13-OCT-2022 17:08', 'DD-MON-YYYY HH24:MI'), TO_DATE('15-OCT-2022 14:08', 'DD-MON-YYYY HH24:MI'), 'Screen blank', 502, 0, 'GEN', NULL);
INSERT INTO Call_Details VALUES
(Call_seq.NEXTVAL, 'Briana', 2003, '8500095B', 8001, TO_DATE('13-OCT-2022 14:08', 'DD-MON-YYYY HH24:MI'), NULL, 'Machine will not boot', NULL, 1, 'BOOT4', NULL);
INSERT INTO Call_Details VALUES
(Call_seq.NEXTVAL, 'Estella', 2004, '2BCf0932A', 8001, TO_DATE('13-OCT-2022 14:08', 'DD-MON-YYYY HH24:MI'), NULL, 'Cannot log into OS', NULL, 1, 'PASS', NULL);
INSERT INTO Call_Details VALUES
(Call_seq.NEXTVAL, 'Shawna', 2000, '2BCf0932A', 8022, TO_DATE('13-OCT-2022 14:08', 'DD-MON-YYYY HH24:MI'), NULL, 'Mouse not working', 504, 1, 'MOUSE', NULL);
INSERT INTO Call_Details VALUES
(Call_seq.NEXTVAL, 'Shawna', 2000, '1BC0095B1', 8022, TO_DATE('13-OCT-2022 11:11', 'DD-MON-YYYY HH24:MI'), TO_DATE('13-OCT-2022 12:08', 'DD-MON-YYYY HH24:MI'), 'Screen blank', 502, 0, 'GEN', NULL);
INSERT INTO Call_Details VALUES
(Call_seq.NEXTVAL, 'Briana', 2003, '8500095B', 8001, TO_DATE('13-OCT-2022 14:08', 'DD-MON-YYYY HH24:MI'), NULL, 'Machine will not boot', NULL, 1, 'BOOT4', NULL);
INSERT INTO Call_Details VALUES
(Call_seq.NEXTVAL, 'Melinda', 2006, '2BCf0932A', 8001, TO_DATE('13-OCT-2022 14:08', 'DD-MON-YYYY HH24:MI'), NULL, 'Cannot log into OS', NULL, 1, 'PASS', NULL);
INSERT INTO Call_Details VALUES
(Call_seq.NEXTVAL, 'Estella', 2004, '2BCf0932A', 8022, TO_DATE('13-OCT-2022 14:08', 'DD-MON-YYYY HH24:MI'), NULL, 'Mouse not working', 504, 1, 'MOUSE', NULL);
INSERT INTO Call_Details VALUES
(Call_seq.NEXTVAL, 'Estella', 2004, '1BC0095B1', 8022, TO_DATE('13-OCT-2022 14:08', 'DD-MON-YYYY HH24:MI'), TO_DATE('14-OCT-2022 09:08', 'DD-MON-YYYY HH24:MI'), 'Screen blank', 502, 0, 'GEN', NULL);
